  ...
  public static void main (String[] args){
   ...
   Scanner input = new Scanner (System.in);
       ...
       System.out.print(bot +"The Sun Hours per day in Philippines is 5 hours!"+ bot +"Enter your Sunhours \n [ Input Here ]: ");
             ...
             double solarpanelproduce2 = (solarpanelproduce1/1000);
       ...
       System.out.print(bot +"The Sun Hours per day in Philippines is 5 hours!"+ bot + "Enter Your Sunhours \n [ Input Here ]: ");
             ...
             double solarpanelproduce3 = (265*sunhours2);
             double solarpanelproduce4 = (solarpanelproduce3/1000);
             double sp2 = (kwhh/solarpanelproduce4);
